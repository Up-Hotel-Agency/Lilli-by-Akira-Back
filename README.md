...
To access your new WordPress site, visit <http://localhost:4444>
...
# before initial upload of theme folder
  ...
  1. change theme folder name from lilli-by-akira-back to a relevant name for the client
  ...
  5. do a find and replace of "lilli-by-akira-back" to your new theme folder name to update all assets / paths
...
# install
  ...
  1. Install gulp & deps
      `cd public_html/wp-content/themes/lilli-by-akira-back`
      `npm install`
...
# watching for SASS changes etc
  ...
  cd to theme dir eg: `cd public_html/wp-content/themes/lilli-by-akira-back`
