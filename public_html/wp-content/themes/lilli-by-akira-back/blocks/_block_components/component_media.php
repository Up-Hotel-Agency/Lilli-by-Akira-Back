...
function block_media($field, $opts = [] ){
    ...
    //Exit early if media array is not found within defined field 
    if(!isset($field['media'])){
        echo "Couldn't find media array within defined field.";
        return;
    }
    ...
    if($mediaType == "image"):
        ...
        ?><div class="media-container <?php if(!$allowAspect): ?> no-aspect <?php endif; ?> image-carousel <?php if($imgArray && $allow_dynamic ): ?> js-image-carousel <?php endif; ?>"><?php
    ...
    elseif($mediaType == "video"):
        ...
        if($videoOptions['video_source'] == "youtube"):
            ...
            ?>
            <div class="media-container video-media-container <?php if(!$allowAspect): ?> no-aspect <?php endif; ?> ">
                <lite-youtube
                    data-aos="fade-up"
        ...
        if($videoOptions['video_source'] == "direct" || $videoOptions['video_source'] == "file"):
            ...
            ?>
                ...
                <video 
                class="media-container <?php if(!$allowAspect): ?> no-aspect <?php endif; ?> <?php echo $fit; ?> <?php if($values['aspectRatio']): ?> set-aspect <?php endif; ?>  "
...
?>
<img src="<?php echo $image; ?>" class="object-fit no-aspect media-container" alt="">
<?php
}