...
function gallery_grid_render_callback( $block, $content = '', $is_preview = false ) {
    ...
    >
        ...
        <div class="container banner-block flex justify-center items-center flex-col gallery-grid-banner-block<?php include get_template_directory() . '/blocks/_block_components/component_block_class.php';  //Apply classes from ACF row settings ?>">
        ...
        <div class="container nopadd-mob">
    ...
    if( $loop->have_posts() ): ?>
        <?php $galleryModal = 1; while ( $loop->have_posts() ) : $loop->the_post(); $gallery = get_the_ID(); ?>
            ...
            <div class="gallery-modal-sidebar flex flex-col sm:flex-row items-center justify-between">
                <a class="js-modal-close gallery-close button icon secondary no-margin" href="#"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g><title>Close</title><line x1="4.755" y1="19.245" x2="19.245" y2="4.755" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/><line x1="19.245" y1="19.245" x2="4.755" y2="4.755" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/></g></svg></a>
                <div class="gallery-modal-controls">
                    <button class="js-gallery-modal-prev button icon secondary no-margin"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Previous</title><polyline points="14.842 17.685 9.158 12 14.842 6.315" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/></svg></button>
                    <button class="js-gallery-modal-next button icon secondary no-margin"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Next</title><polyline points="9.158 6.315 14.842 12 9.158 17.685" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/></svg></button>
