...
function initializeExploreMap() {
    ...
    $('.explore-map').each(function(){
        ...
        function add_marker( $marker, map ) {
            ...
            var markerPin = {
                url: '/wp-content/themes/lilli-by-akira-back/assets/img/map-pin-inactive.svg',
            ...
            if( category == 'hotel' ) {
                var markerPin = {
                    url: '/wp-content/themes/lilli-by-akira-back/assets/img/map-pin-logo.svg',
...
function neighbourhood(){
    ...
    if(neighbourhoodInit) {
        ...
        if(googleMapScriptLoaded) {
            ...
            loadNeighbourhoodScript('https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyBUf5K9jbIqHdmKkqhz0cSatK0DMfOOzDACb4yfZhPvS3pTzhiVUR3E5jZ7UHNF1HZc&callback=neighbourhood', function() {
