...
function google_map_render_callback( $block, $content = '', $is_preview = false ) {
    ...
    data-aos-id="googlemap" <?php if( $location ):?> data-aos="fade-up" <?php endif; ?>
    >
        ...
        <div class="map-container">
            ...
            <?php else: ?>
                <img 
                    class="map-fallback object-fit" 
                    src="<?php echo get_template_directory_uri() . '/assets/img/map_frame.png'; ?>" 
