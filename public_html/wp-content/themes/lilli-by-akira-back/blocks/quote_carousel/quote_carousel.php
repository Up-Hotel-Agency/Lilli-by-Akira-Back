...
acf_register_block_type(array(
    ...
    'render_callback'   => 'quote_carousel_render_callback',
    'category'          => 'upcore-blocks',
    'icon'              => 'slides', // dashicons, without the leading dashicons-
    'keywords'          => array( 'quote', 'carousel', 'testimonial' ),
    'enqueue_script'    => get_template_directory_uri() . '/assets/js/quote_carousel/quote_carousel.min.js',
    'enqueue_style'     => get_template_directory_uri() . '/assets/css/quote_carousel/quote_carousel.css',
    'mode'              => 'preview',
    'supports'          => array(
                                    'align'     => false,
                                    'anchor'    => true,
...
function quote_carousel_render_callback( $block, $content = '', $is_preview = false ) {
    ...
    >
        ...
        <?php endif; ?>
        " data-aos="fade-up">
            <div class="quote-carousel js-quote-carousel">
                ...
                $slideCount = count(get_field('slide')); ?>
                    ...
                    >
                        <div class="quote-carousel-slide-inner centered">
                            
                            <?php if( get_sub_field('quote') ): ?>
                                <p class="size-xl xs:size-l mb-6 bold">“<?php the_sub_field('quote'); ?>”</p>
                            <?php endif; ?>
            ...
            <?php if( $slideCount > 1 ): ?>
                <div class="slick-controls flex justify-center items-center">
                    <a href="#" class="js-quote-prev slick-control" title="Previous slide"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><title>Previous</title><g class="caret-left"><polyline class="arrowhead" points="29.018 36.036 16.982 24 29.018 11.964" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/></g></svg></a>
                    <div class="slick-dots quote-dots"></div>
                    <a href="#" class="js-quote-next slick-control" title="Next slide"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><title>Next</title><g class="caret-right"><polyline class="arrowhead" points="18.982 11.964 31.018 24 18.982 36.036" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/></g></svg></a>
                </div>
            <?php endif; ?>
        </div>
        <?php if( get_field('display_image') ): ?>
