...
function block_plugin_editor_scripts() {
    ...
    function inspect_scripts() {
        ...
        foreach ($wp_scripts->queue as $handle) {
            ...
            if (strpos($handle_data->src, '/wp-content/themes/lilli-by-akira-back/assets/js/') !== false) {
                $handle_list[] = array(
                'handle' => $handle,
                'src' => $handle_data->src
                );
...
add_action( 'enqueue_block_assets', function() {
    wp_enqueue_script('page-color-transition-js', get_template_directory_uri() . '/assets/js/_block_components/component_page_color_transition/component_page_color_transition.min.js');
} );
