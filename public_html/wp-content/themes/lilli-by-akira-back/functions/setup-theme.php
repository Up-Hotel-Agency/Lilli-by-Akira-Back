...
function replace_core_jquery_version() {
    ...
    wp_register_script( 'jquery', "/wp-content/themes/lilli-by-akira-back/assets/js/jquery-3.5.1.min.js", array(), '3.5.1' );
}
...
/**
* @desc Dequeue gutenberg style sheet from pages that are not using gutenberg blocks
*/
function dequeue_block_library() {
    ...
    // Match core blocks only (not ACF)
    if (!preg_match('/<!-- wp:(?!acf\/)/', $content)) {
