...
if( get_event_single_type() == 'event_2' ) { ?>
    ...
    <div id="scroll-target" class="single-modal forced">
        <a href="<?php echo get_the_permalink( get_field('events_page', 'options') ); ?>" aria-lable="close-modal" class="modal-close flex justify-center items-center">
                            ...
                            <p class="flex items-center">
                                ...
                                <?php
                                    ...
                                    if(get_field('date_range')){
                                        $date_end = date_create(get_field('end_date'));
