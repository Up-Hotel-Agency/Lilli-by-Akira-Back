    ...
    <div class="rooms-guests-fields flex no-margin">
        ...
        <div class="rooms-guests-select theme--default">
            <div class="select-inner">
                <div class="selector-wrap flex items-center justify-between mb-6" data-max="12" data-min="1">
                    ...
                    <div class="selector flex items-center">
                        <button class="selector-control minus button icon secondary size-s no-margin disabled">
