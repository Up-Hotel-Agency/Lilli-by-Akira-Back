<section class="row container banner-block flex justify-center items-center<?php if( has_post_thumbnail() || get_field('featured_image__video') ): ?> theme--image<?php endif; ?>" id="scroll-target">
    <div class="block-bg-img overlay--medium">
    ...
    <div class="banner-content-block">
        <a class="button icon-left back no-margin minor" href="<?php echo get_permalink( get_option( 'page_for_posts' ) ); ?>">
