...
<?php if( get_field('activate_exit_capture', $options) ): ?>
    <div class="
            ...
            <?php if( !get_field('aggressive_exit_capture',$options) ): ?>js-session-cookie<?php else: ?>aggressive-popup<?php endif; ?>
        "
    >
        <div class="exitcapture-container flex items-center justify-center">
            ...
            <div class="modal flex text-center<?php if( get_field('exit_capture_img',$options) ): ?> has-image<?php endif; ?>">
                ...
                <div class="modal-content">
                    <h3 class="modal-title"><?php the_field('exit_capture_title', $options); ?></h3>
                    <div class="mb-8">
                    ...
                    <?php if( get_field('display_exit_capture_countdown',$options) && get_field('exit_capture_countdown',$options) ): ?>
                        <div style="display: none;" class="countdown js-conversion-tools-countdown mb-8" data-countdown-date="<?php the_field('exit_capture_countdown', $options); ?>">
                            <div class="countdown-inner flex justify-center items-center">
                                <div class="countdown-item js-conversion-tools-countdown-days">days</div>
                                <div class="countdown-item js-conversion-tools-countdown-hours">hrs</div>
                                <div class="countdown-item js-conversion-tools-countdown-minutes">mins</div>
                            </div>
                        </div>
                    <?php endif; ?>
...
<?php if( get_field('activate_slide_callout',$options) ): ?>
    <div class="
        ...
        <?php if( !get_field('aggressive_slide_callout',$options) ): ?>js-session-cookie<?php else: ?>aggressive-callout<?php endif; ?>
        "
    >
...
<?php if( get_field('activate_highlight_bar',$options) ): ?>
    <div class="
        highlight-bar js-highlight-bar
        <?php if( !get_field('aggressive_highlight_bar',$options) ): ?>js-session-cookie<?php else: ?>aggressive-highlight-bar<?php endif; ?>
        "
    >
        <div class="highlight-bar-container">
            <div class="highlight-bar-inner">
                <h3 class="body-s no-margin"><?php the_field('highlight_bar_title',$options); ?></h3>
                <?php if( get_field('display_highlight_bar_countdown',$options) && get_field('highlight_bar_countdown',$options) ): ?>
                    <div style="display: none;" class="countdown js-conversion-tools-countdown" data-countdown-date="<?php the_field('highlight_bar_countdown', $options); ?>">
            ...
            <?php block_buttons(get_field('highlight_bar_button_link', $options), [
                'class' => 'button no-margin button-text-s',
                'type'  => 'primary'
            ]); ?>
            </div>
